...
function RoleCreatePage() {
  ...
  const formik = useFormik<RoleInterface>({
    initialValues: {
      role_descriptiong: '',
      role_description: (router.query.role_description as string) ?? null,
    },
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <TextInput
            error={formik.errors.role_descriptiong}
            label={'Role Descriptiong'}
            props={{
              name: 'role_descriptiong',
              placeholder: 'Role Descriptiong',
              value: formik.values?.role_descriptiong,
