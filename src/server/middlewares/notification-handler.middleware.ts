...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': { roles: ['administrator', 'editor', 'member'], key: 'order', tenantPath: [], userPath: [] },
  ...
  'product.create.create': { roles: ['administrator', 'editor'], key: 'product', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['administrator'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['administrator', 'editor', 'member'];
